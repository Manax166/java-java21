...
public class Function_01_Test {
    ...
    private Function<Integer, Person> intToPerson = new Function<Integer, Person>() {
        ...
        public Person apply(Integer integer) {
            String first = "first_"+ integer;
            String last = "last_" + integer;
            String pass = "pass_" + integer;
            return new Person(first, last, integer, pass);
        }
    };
    // end::intToPerson[]
    ...
    private Function<Person, Account> personToAccount = new Function<Person, Account>() {
        ...
        public Account apply(Person person) {
            ...
            accRes.setOwner(person);
            accRes.setBalance(1000);
            return accRes;
        }
    };
    // end::personToAccount[]

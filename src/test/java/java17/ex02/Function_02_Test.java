...
public class Function_02_Test {
    ...
    BiFunction<Person, Integer, Account> buildAccount = new BiFunction<Person, Integer, Account>() {
        @Override
        public Account apply(Person person, Integer integer) {
            Account acc = new Account();
            acc.setBalance(integer);
            acc.setOwner(person);
            return acc;
        }
    };
